class NJFET extends BaseTransistor {
    ...
    constructor(posx = '500px', posy = '500px') {
        ...
        this.model = `.model ${this.modelName} NJFET (L=${this.L} W=${this.W} VTO=${this.VTO} BETA=${this.BETA} GAMMA=${this.GAMMA} PHI=${this.PHI} LAMBDA=${this.LAMBDA} IS=${this.IS})`;
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">NJFET Model Parameters</h5>
                </div>
...
export function AddNJFET(posx, posy) {
    return new NJFET(posx, posy);
}
